...
public class ToolsSignalReconnectActivity extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		DisableGprsUtil.checkState(ToolsSignalReconnectActivity.this);
	...
	public void onClick(View v) {
		...
		case R.id.btn_ctrl:
			if(SignalReconnectUtil.isSignalReconnectOn()) {
				SignalReconnectUtil.ctrlSignalReconnect(ToolsSignalReconnectActivity.this, false);
				MyToast.makeText(ToolsSignalReconnectActivity.this, R.string.toast_close_ok, Toast.LENGTH_LONG, false).show();
				  
			} else {
				SignalReconnectUtil.ctrlSignalReconnect(ToolsSignalReconnectActivity.this, true);
				MyToast.makeText(ToolsSignalReconnectActivity.this, R.string.toast_open_ok, Toast.LENGTH_LONG, false).show();
